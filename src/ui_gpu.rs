...
fn get_props_index_for_resource(resource_name: &str) -> u32 {
    match resource_name {
        "Population" => 13,   // Первый спрайт (0, 0)
        "Gold" => 135,        // Второй спрайт (1, 0)
        "Happiness" => 658,   // Третий спрайт (2, 0)
        "Tax" => 159,         // Четвертый спрайт (3, 0)
        ...
        "Wood" => 251,       // Первый спрайт второй строки (0, 1)
        "Stone" => 26,      // Второй спрайт второй строки (1, 1)
        ...
        "Bread" => 513,      // Седьмой спрайт второй строки (6, 1)
        "Fish" => 352,       // Восьмой спрайт второй строки (7, 1)
        "Iron Ore" => 208,   // Девятый спрайт второй строки (8, 1)
        "Iron Ingots" => 217, // Десятый спрайт второй строки (9, 1)
