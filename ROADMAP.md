...
- Быстрые победы (можно сделать сегодня)
  ...
  [x] Погода-оверлей: дождь/туман/снег как экранные слои с влиянием на производство. Точка: `main.rs::overlay_tint`, хук в симуляции `game.rs`.

- Визуал и пикс-арт
  [x] Ночные окна домов (мигающие «светлячки» у `House`) и факелы на дорогах ночью.
  [x] Призраки построек для предпросмотра
...
- Мир и генерация
  [x] Биомы: луга/болота/скалы с разными модификаторами (у нас уже есть noise).
  [x] Реки как перлин-потоки; мосты как особая дорога.

- Ивенты
  - Праздник (бафф счастья/налога), засуха (минус пшеница), бандитский налёт на склады (мини-задача на «охрану» или уплату).

- UX/удобство
  [x] Мини-карта (низ-право): даунскейл тайлов, маркер камеры.
